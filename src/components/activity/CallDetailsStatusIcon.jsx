...
import { DIRECTION, CALL_TYPE } from "../../utils/constants";

const CallDetailsStatusIcon = ({ direction, callType }) => {
  // ENHANCEMENT: can export svg file and reference to <img> element
  const renderIcon = () => {
    if (callType === CALL_TYPE.VOICEMAIL) {
      return (
        <svg
  ...
  return <span className={`icon ${callType}`}>{renderIcon()}</span>;
};

export default CallDetailsStatusIcon;
